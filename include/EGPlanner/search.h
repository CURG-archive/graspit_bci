...
enum SearchEnergyType{ENERGY_CONTACT,ENERGY_PARTIAL_VIEW_CONTACT,ENERGY_HEATMAP_PARTIAL_VIEW_CONTACT, ENERGY_POTENTIAL_QUALITY, ENERGY_CONTACT_QUALITY,
					  ENERGY_AUTOGRASP_QUALITY, ENERGY_GUIDED_AUTOGRASP, ENERGY_STRICT_AUTOGRASP,
                      ENERGY_COMPLIANT, ENERGY_DYNAMIC, ENERGY_HEATMAP, ENERGY_HEATMAP_CONTACT};
