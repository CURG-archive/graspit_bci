...
grasp_planner::getCylinderGraspDirections(SoPath *sop) {
    ...
    ccpoint[0] = 0.0;
    ccpoint[1] = 0.0;
    ccpoint[2] = height / 2 + STARTING_DISTANCE;
    ccdir[0] = 0.0;
    ccdir[1] = 0.0;
    ccdir[2] = -1.0;
    /* fill structure */
    ...
    ccpoint[0] = 0.0;
    ccpoint[1] = 0.0;
    ccpoint[2] = (-1) * (height / 2 + STARTING_DISTANCE);
    ccdir[0] = 0.0;
    ccdir[1] = 0.0;
    ccdir[2] = 1.0;
    /* fill structure */
    ...
    for (int curr_plane = 1; curr_plane <= nr_of_parallel_planes_height; curr_plane++) {
        ...
        for (double step = 0.0; step <= 2 * M_PI - DELTA_360_DEG_ERROR; step += (2 * M_PI) / nr_of_360_deg_steps) {
            cgd = new cartesianGraspDirection;
            ccpoint[0] = radius + STARTING_DISTANCE;
            ccpoint[1] = step;
            ccpoint[2] = plane_height;
            ccdir[0] = -1.0;
            ccdir[1] = 0.0;
            ccdir[2] = 0.0;
            /* fill structure */
...
grasp_planner::getCubeGraspDirections(SoPath *sop) {
    ...
    for (curr_planeA = 1; curr_planeA <= nr_of_parallel_planes_width; curr_planeA++) {
        for (curr_planeB = 1; curr_planeB <= nr_of_parallel_planes_depth; curr_planeB++) {
            ...
            cgd = new cartesianGraspDirection;
            ccpoint[0] = plane_heightA;
            ccpoint[1] = height + STARTING_DISTANCE;
            ccpoint[2] = plane_heightB;
            ccdir[0] = 0.0;
            ccdir[1] = -1.0;
            ccdir[2] = 0.0;
            /* fill structure */
    ...
    for (curr_planeA = 1; curr_planeA <= nr_of_parallel_planes_width; curr_planeA++) {
        for (curr_planeB = 1; curr_planeB <= nr_of_parallel_planes_depth; curr_planeB++) {
            ...
            cgd = new cartesianGraspDirection;
            ccpoint[0] = plane_heightA;
            ccpoint[1] = -1 * (height + STARTING_DISTANCE);
            ccpoint[2] = plane_heightB;
            ccdir[0] = 0.0;
            ccdir[1] = 1.0;
            ccdir[2] = 0.0;
    ...
    for (curr_planeA = 1; curr_planeA <= nr_of_parallel_planes_height; curr_planeA++) {
        for (curr_planeB = 1; curr_planeB <= nr_of_parallel_planes_depth; curr_planeB++) {
            ...
            cgd = new cartesianGraspDirection;
            ccpoint[0] = width + STARTING_DISTANCE;
            ccpoint[1] = plane_heightA;
            ccpoint[2] = plane_heightB;
            ccdir[0] = -1.0;
            ccdir[1] = 0.0;
            ccdir[2] = 0.0;
    ...
    for (curr_planeA = 1; curr_planeA <= nr_of_parallel_planes_height; curr_planeA++) {
        for (curr_planeB = 1; curr_planeB <= nr_of_parallel_planes_depth; curr_planeB++) {
            ...
            cgd = new cartesianGraspDirection;
            ccpoint[0] = -1 * (width + STARTING_DISTANCE);
            ccpoint[1] = plane_heightA;
            ccpoint[2] = plane_heightB;
            ccdir[0] = 1.0;
            ccdir[1] = 0.0;
    ...
    for (curr_planeA = 1; curr_planeA <= nr_of_parallel_planes_width; curr_planeA++) {
        for (curr_planeB = 1; curr_planeB <= nr_of_parallel_planes_height; curr_planeB++) {
            ...
            cgd = new cartesianGraspDirection;
            ccpoint[0] = plane_heightA;
            ccpoint[1] = plane_heightB;
            ccpoint[2] = depth + STARTING_DISTANCE;
            ccdir[0] = 0.0;
            ccdir[1] = 0.0;
            ccdir[2] = -1.0;
            /* fill structure */
    ...
    for (curr_planeA = 1; curr_planeA <= nr_of_parallel_planes_width; curr_planeA++) {
        for (curr_planeB = 1; curr_planeB <= nr_of_parallel_planes_height; curr_planeB++) {
            ...
            ccpoint[0] = plane_heightA;
            ccpoint[1] = plane_heightB;
            ccpoint[2] = -1 * (depth + STARTING_DISTANCE);
            ccdir[0] = 0.0;
            ccdir[1] = 0.0;
            ccdir[2] = 1.0;
            /* fill structure */
