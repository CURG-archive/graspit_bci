...
namespace db_planner {
    ...
    public:
        ...
        double EpsilonQuality() const {
            return epsilon_quality_;
        }

        double VolumeQuality() const {
            return volume_quality_;
        }
        ...
        virtual bool Transform(const float /*transform*/[16]) {
            return false;
        }
