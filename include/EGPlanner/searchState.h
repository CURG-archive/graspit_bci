...
public:
    ...
    transf getTotalTran() const {
        return mPosition->getCoreTran() * mRefTran;
    }

    PostureState *getPosture() {
        return mPosture;
    }

    const PostureState *readPosture() const {
        return mPosture;
    }
    ...
    const PositionState *readPosition() const {
        return mPosition;
    }
    ...
    int getNumVariables() const {
        return mPosture->getNumVariables() + mPosition->getNumVariables();
    }
    ...
    void setAttribute(QString name, double value) {
        mAttributes->setParameter(name, value);
    }

    double getAttribute(QString name) const {
        return mAttributes->getParameter(name);
    }

    void addAttribute(QString name, double value) {
        mAttributes->addParameter(name, value);
    }

    void removeAttribute(QString name) {
        mAttributes->removeParameter(name);
    }

    bool hasAttribute(const QString &name) const {
        return mAttributes->hasParameter(name);
    }
...
private:
    ...
    double mQualVolume;
    //! A vector of secondary qualities
    std::vector<double> graspQualities;
...
public:
    ...
    const std::vector<double> *getQualityMeasures() const {
        return &graspQualities;
    }
