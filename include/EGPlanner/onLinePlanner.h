...
public:
    ...
    virtual PlannerType getType() {
        return PLANNER_ONLINE;
    }

    virtual Hand *getRefHand() {
        return mRefHand;
    }
    ...
    double getSolutionDistance() const {
        return mSolutionDistance;
    }

    double getObjectDistance() const {
        return mObjectDistance;
    }

    int getSABufferSize() const {
        return (int) mCandidateList.size();
    }
    ...
    Hand *getSolutionClone() {
        return mSolutionClone;
    }

    GraspTester *getGraspTester() {
        return mGraspTester;
    }
