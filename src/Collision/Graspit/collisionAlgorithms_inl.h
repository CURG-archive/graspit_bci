...
//#define PROF_ENABLED
#include "profiling.h"
PROF_DECLARE(COLLISION_RECURSION);PROF_DECLARE(CONTACT_LEAF);PROF_DECLARE(CONTACT_QUICK);PROF_DECLARE(COLLISION_LEAF);PROF_DECLARE(COLLISION_QUICK);PROF_DECLARE(DISTANCE_LEAF);PROF_DECLARE(DISTANCE_QUICK);
